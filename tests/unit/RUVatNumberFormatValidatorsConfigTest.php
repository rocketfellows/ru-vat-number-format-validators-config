...
namespace rocketfellows\RUVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\RUVatNumberFormatValidatorsConfig\RUVatNumberFormatValidatorsConfig;

class RUVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = RUVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = RUVatFormatValidator::class;
