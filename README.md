# Russian Federation vat number format validators config

![Code Coverage Badge](./badge.svg)

This package provides a preconfigured configuration class for vat number format validators for Russian Federation country.
Is an extension of the package https://github.com/rocketfellows/specific-country-vat-number-format-validators-config.

## Installation

```shell
composer require rocketfellows/ru-vat-number-format-validators-config
```

## Dependencies

- https://github.com/rocketfellows/specific-country-vat-number-format-validators-config v1.0.0;
- https://github.com/rocketfellows/ru-vat-format-validator v1.0.0;
...
- **_rocketfellows\RUVatNumberFormatValidatorsConfig\RUVatNumberFormatValidatorsConfig_** - preconfigured configuration class for vat number format validators for Russian Federation country;

## RUVatNumberFormatValidatorsConfig description

A configuration class that provides a match for the vat number format validators for the country Russian Federation.

Class interface:
- **_getCountry_** - returns Russian Federation **_Country_** instance;
- **_getValidators_** - returns validators tuple

When initializing the default configuration, the **_getValidators_** function returns a tuple with a single validator - an instance of RUVatFormatValidator.

```php
$config = new RUVatNumberFormatValidatorsConfig();

$config->getCountry();      // returns Russian Federation Country instance
$config->getValidators();   // returns CountryVatFormatValidators with one item - instance of RUVatFormatValidator
```
...
$config = new RUVatNumberFormatValidatorsConfig($newDefaultValidator);  // initialize with new default validator
...
// default preconfigured validator by default - instance of RUVatFormatValidator
